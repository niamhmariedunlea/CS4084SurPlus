...
public class SupplierProfileFragment extends Fragment {
        ...
        documentReference.get()
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        ...
                        {
                            Intent intent = new Intent(getActivity(), SupplierRegistrationActivity.class);
    ...
    private void updateProfile() {
        ...
        final DocumentReference sDoc = firebaseFirestore.collection("suppliers").document(currentId);
